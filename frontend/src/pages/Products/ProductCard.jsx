      ...
      <div className="p-5">
        ...
        <section className="flex justify-between items-center">
         ...
         {cart.cartItems.some((item) => item._id === p._id) ? (
             <button
          disabled
          className="flex items-center gap-2 px-5 py-2.5 bg-green-500 text-white rounded-xl shadow-md cursor-not-allowed opacity-90"
        >
          ...
          className="flex items-center gap-2 px-5 py-2.5 bg-indigo-600 text-white rounded-xl shadow-md hover:bg-indigo-700 active:scale-95 transition"
